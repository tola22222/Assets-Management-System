                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition">
                        ...
                        <td class="p-4 pr-5 text-right">
                            <div class="flex items-center justify-end gap-1.5">
                                ...
                                <form action="{{ route('asset-assignments.cancel', $assignment) }}" method="POST" class="inline" onsubmit="return confirm('Cancel this assignment?')">
                                    @csrf
                                    <button type="submit"
                                ...
                                @endif
                                <form action="{{ route('asset-assignments.destroy', $assignment) }}" method="POST" class="inline" onsubmit="return confirm('Delete?')">
                                    @csrf @method('DELETE')
                                    <button type="submit"
