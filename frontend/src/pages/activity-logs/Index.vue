...
<template>
  <AppLayout>
    <div class="p-6 sm:p-8 space-y-6">
          ...
          <table class="data-table">
            ...
            <tbody>
              <tr v-for="log in sortedLogs" :key="log.id">
                ...
                <td class="text-right">
                  <button @click="removeLog(log.id)" :title="t('common.delete')" class="btn-icon-danger">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /><line x1="10" y1="11" x2="10" y2="17" /><line x1="14" y1="11" x2="14" y2="17" /></svg>
                  </button>
                </td>
              </tr>
      ...
      <!-- Server-paginated: the API fixes the page size at 20, so the
           rows-per-page selector is hidden rather than shown doing nothing. -->
      <TablePagination
        :count="totalLogs"
        :page="currentPage - 1"
        :rows-per-page="perPage"
        :rows-per-page-options="[]"
        @update:page="loadPage($event + 1)"
      />
    </div>
  </AppLayout>
</template>
