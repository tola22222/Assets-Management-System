...
class AssetAssignment extends Model
{
    ...
    /**
     * Statuses meaning "the asset is out with someone". A new assignment starts
     * as `assigned` and may later be marked `active`; both are current.
     */
    public const CURRENT_STATUSES = ['assigned', 'active'];

    // Scope for current (assigned or active) assignments
