...
const { sortKey, sortDir, toggleSort, sorted: sortedReturns } = useTableSort(searched, {
    ...
    <div class="p-6 sm:p-8 space-y-6">
      <div class="card p-6 sm:p-8">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 class="font-display text-3xl font-bold text-fg tracking-tight">{{ t('asset_returns.title') }}</h1>
            <p class="text-muted text-sm mt-1">{{ t('asset_returns.subtitle') }}</p>
          </div>
